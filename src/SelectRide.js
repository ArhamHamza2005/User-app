...
function SelectRide({ route }) {
  ...
  const calculateFare = async (vehale) => {
    ...
    alert(("Rs. " + fare.toFixed(2))+"\n"+"request send to draiver Please Wait");
        ...
        <View>
          ...
          >
            <Pressable onPress={() => calculateFare("bike")}>
              <Image
                source={{
                  uri: "https://cdn.dribbble.com/users/313131/screenshots/1870943/motorcycle_guy_layered.gif",
                }}
            ...
            <Pressable onPress={() => calculateFare("car")}>
              <Image
                source={{
                  uri: "https://i.pinimg.com/originals/65/5d/2d/655d2da400a648abca600766a89deead.gif",
                }}
                style={{ width: 160, height: 160 }}
              />
            </Pressable>
